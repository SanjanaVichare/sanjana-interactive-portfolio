 ...
 *   tablet  640–1023px → 2-col hero, 1-col about cards
 *   desktop ≥ 1024px  → full 2-col hero, 3-col + 2-col about
 */
...
const pill: CSSProperties = {
    ...
    outline: "none",
    transition:
        "background 0.25s, color 0.25s, border-color 0.25s, box-shadow 0.3s, transform 0.2s",
};
...
const CODE_LINES: CodeLine[] = [
    ...
    },
    {
        tokens: [
            { t: "plain", v: "  loves: " },
            { t: "str", v: '"turning ideas into software"' },
            { t: "plain", v: "," },
        ],
    },
    {
    ...
    CODE_LINES.forEach((line) => {
        line.tokens.forEach((tok) => {
            tok.v.split("").forEach((ch) => {
                seq.push({
                    char: ch,
                    color: TOKEN_COLORS[tok.t] ?? TOKEN_COLORS.plain,
                    isNewline: false,
                });
            });
        });
        ...
        >
            ...
            <div
                onClick={(e) => {
                    ...
                    setProgress(
                        Math.round(
                            ((e.clientX - rect.left) / rect.width) * SONG.duration
                        )
                    );
                }}
                style={{
...
function HoverIcon({
    ...
    return (
        <motion.span
            animate={{ rotate: active ? 8 : 0, scale: active ? 1.15 : 1 }}
    ...
    return (
        <motion.div
            ...
            style={{
                ...
                boxShadow: "0 4px 24px rgba(10,51,35,0.08)",
                ...style,
            }}
        >
            {children}
                ...
                >
                    ...
                    {stat.tooltip && (
                        ...
                        >
                            <Info
                                size={11}
                                style={{ color: C.pageBg, opacity: 0.4, cursor: "help" }}
                            />
                            <AnimatePresence>
                                {showTip && (
                                    <motion.div
                ...
                >
                    <div
                        style={{
                            ...
                            borderRadius: "50%",
                            background: C.pageBg,
                            border: `2px solid ${C.primaryText}`,
            ...
            {items.map((item, i) => (
                <div
                    ...
                    style={{
                        ...
                        padding: "5px 0",
                        borderTop:
                            i > 0 ? "1px solid rgba(247,244,213,0.08)" : "none",
                    }}
                >
                    {item}
                </div>
                ...
                {isMobile && menuOpen && (
                    <motion.div
                        ...
                        style={{
                            ...
                            right: "1rem",
                            zIndex: 99,
                            background: "rgba(247,244,213,0.98)",
                            backdropFilter: "blur(16px)",
                            borderRadius: 20,
                            border: `1px solid ${C.border}`,
                            boxShadow: "0 8px 32px rgba(10,51,35,0.15)",
                            padding: "12px",
                            display: "flex",
                    ...
                    >
                        {links.map((link) => (
                            <button
                                ...
                                onMouseEnter={(e) =>
                                    (e.currentTarget.style.background = "rgba(10,51,35,0.06)")
                                }
                                onMouseLeave={(e) =>
                                    (e.currentTarget.style.background = "none")
                                }
          ...
          `,
            ...
            <motion.div
                ...
                style={{
                    ...
                    padding: isMobile
                        ? "2rem 1.25rem 3rem"
                        : "2rem clamp(1.5rem, 5vw, 4rem) 4rem",
                }}
            >
                <div
                    style={{
                        ...
                        gap: isMobile ? "2.5rem" : isTablet ? "2rem" : "clamp(2rem, 5vw, 7rem)",
                        alignItems: "center",
                    }}
                >
                    {/* ── Left column ── */}
                    ...
                    >
                        ...
                        >
                            ...
                            interactive, human-centred technology — from Flutter mobile apps
                            and full-stack systems to experimental game projects. I love
                            turning ideas into polished, living software.
                        </motion.p>
                        ...
                        >
                            <MagnetWrap>
                                <motion.button
                                    ...
                                    style={{
                                        ...pill,
                                        background:
                                            hoveredBtn === "projects" ? C.primaryText : C.accent,
                                        color: C.pageBg,
                                        boxShadow:
                                            hoveredBtn === "projects"
                                                ? "0 14px 36px rgba(10,51,35,0.24)"
                                                : "0 6px 20px rgba(16,86,102,0.25)",
                                        padding: isMobile ? "10px 18px" : "11px 20px",
                                    }}
                                >
                                    <HoverIcon active={hoveredBtn === "projects"}>
                                        <ArrowDown size={15} />
                                    </HoverIcon>
                                    View Projects
                                </motion.button>
                            ...
                            <MagnetWrap>
                                <motion.a
                                    href="https://linkedin.com/in/sanjana-vichare"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    {...h("li")}
                                    whileTap={{ scale: 0.95 }}
                                    style={{
                                        ...
                                        background:
                                            hoveredBtn === "li"
                                                ...
                                                : "transparent",
                                        color:
                                            hoveredBtn === "li" ? C.primaryText : C.moss,
                                        border: "1.5px solid transparent",
                                        padding: isMobile ? "10px 18px" : "11px 20px",
                                    }}
                                >
                                    <HoverIcon active={hoveredBtn === "li"}>
                                        <Linkedin size={15} />
                                    </HoverIcon>
                                    LinkedIn
                                </motion.a>
                            ...
                            <MagnetWrap>
                                ...
                                >
                                    <HoverIcon active={hoveredBtn === "dl"}>
                                        <Download size={15} />
                                    </HoverIcon>
                                    Resume
                                </motion.button>
...
const STATS: StatItem[] = [
    {
        ...
        value: 92,
        tooltip: "Breaking complex problems into clean, working systems.",
    },
    {
        label: "Full-Stack Development",
        value: 88,
        tooltip: "Flask, React, Flutter — comfortable across the whole stack.",
    },
    {
        label: "Database Design",
        value: 85,
        tooltip:
            "SQLite, MongoDB, SQL — structuring and querying data efficiently.",
    },
    {
        label: "UI & UX Craft",
        value: 83,
        tooltip: "Building interfaces people actually enjoy using.",
    },
    {
        label: "AI & Computer Vision",
        value: 80,
        tooltip:
            "Built a real-time Indian Sign Language recognition system using Python and CV.",
    },
    {
        label: "Mobile Development",
        value: 86,
        tooltip:
            "Flutter apps with real clients — location tracking, admin dashboards, Excel uploads.",
    },
    {
        label: "Shipping Under Pressure",
        value: 91,
        tooltip:
            "Delivered for real clients including a sports org and a finance company.",
    },
    {
...
function AboutSection({
    ...
    const socials: SocBtnDef[] = [
        ...
        },
        {
            ...
            preview: (
                <Popup
                    title="LinkedIn"
                    items={["Software Developer", "Flutter · AI · Games"]}
                />
            ),
        },
        {
    ...
    const col12 = isMobile ? "1fr" : isTablet ? "1fr" : "1fr 2fr";
    ...
    return (
        ...
        >
            <div style={{ maxWidth: 1120, margin: "0 auto" }}>
                ...
                {/* Row 1: Profile · Interests · What I Build */}
                <div
                    style={{ display: "grid", gridTemplateColumns: col3, gap: 18, marginBottom: 18 }}
                >
                    {/* Profile card */}
                    <Card
                        delay={0.05}
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...
                                borderRadius: "50%",
                                background:
                                    "radial-gradient(circle, rgba(211,150,140,0.18), transparent 70%)",
                                pointerEvents: "none",
                            }}
                        />
                        <motion.div
                        ...
                        >
                            Full-stack developer with real shipped projects — from AI
                            accessibility tools and Flutter apps to secure web platforms and
                            an investigation game. I build things that actually get used.
                        </p>
                    </Card>
                    ...
                    <Card delay={0.1} style={{ background: C.forest }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                            {CHIPS.map((c) => (
                                <DragChip key={c.label} icon={c.icon} label={c.label} />
                            ))}
                        </div>
                        <p
                            style={{
                    ...
                    {/* What I Build — on tablet this spans full width of the 2-col, or its own row on mobile */}
                    <Card
                        delay={0.15}
                        style={{
                            background: C.moss,
                ...
                >
                    <Card
                        ...
                        style={{
                            background: C.pageBg,
                            border: "1.5px solid rgba(211,150,140,0.35)",
                        }}
                    >
                        ...
                        >
                            {socials.map((btn) => (
                                <SocButton key={btn.label} btn={btn} />
                            ))}
                        </div>
                        <p
                            style={{
